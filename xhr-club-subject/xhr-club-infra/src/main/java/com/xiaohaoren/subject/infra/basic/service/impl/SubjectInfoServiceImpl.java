...
public class SubjectInfoServiceImpl implements SubjectInfoService {
    ...
    @Override
    public List<SubjectInfo> queryByCondition(SubjectInfo subjectInfo, Long categoryId, Long labelId, int start, Integer pageSize) {
        return this.subjectInfoDao.queryByCondition(subjectInfo, categoryId, labelId, start, pageSize);
    }
