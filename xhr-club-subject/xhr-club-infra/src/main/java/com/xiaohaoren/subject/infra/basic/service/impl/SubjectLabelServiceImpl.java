...
import com.xiaohaoren.subject.infra.basic.mapper.SubjectLabelDao;
...
public class SubjectLabelServiceImpl implements SubjectLabelService {
    ...
    @Override
    public List<SubjectLabel> queryByIds(List<Long> collect) {
        return this.subjectLabelDao.queryByIds(collect);
    }
